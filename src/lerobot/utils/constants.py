...
OBS_DEPTHS = OBS_STR + ".depths"
OBS_MOTOR_CURRENTS = OBS_STR + ".motor_currents"
OBS_MOTOR_VELOCITIES = OBS_STR + ".motor_velocities"
OBS_SENSOR_TIMESTAMPS = OBS_STR + ".sensor_timestamps"
